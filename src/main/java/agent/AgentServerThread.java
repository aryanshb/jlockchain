...
// composite along with agent contoller
// The given code is a Java implementation of a multi-threaded server for a blockchain agent. 
// The server listens to incoming requests from clients and responds accordingly. 
// It uses the Builder design pattern to construct Message objects with different parameters.
